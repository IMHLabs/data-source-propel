...
class Propel
{
    ...
    public static function migration(array $config, $dataSource)
    {
        ...
        $migrationClass->setSchemaPath ( @$migrationSettings ['schema_path'] )->setConfigurationPath ( @$migrationSettings ['config_path'] )->setSqlPath ( @$migrationSettings ['sql_path'] )->setMigrationPath ( @$migrationSettings ['migration_path'] )->setClassPath ( @$migrationSettings ['class_path'] );
